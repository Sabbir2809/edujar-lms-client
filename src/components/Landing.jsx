...
const Landing = () => {
    return (
        <section
            ...
            <div className="mx-auto md:py-40 py-24 md:text-left text-center md:px-0 px-5">

                <h1 className='md:text-6xl text-4xl font-bold tracking-wide text-black mb-10'>
                ...
                <button className="border-2 rounded-[8px] btn btn-success text-white p-3 font-bold mt-6 tracking-widest hover:bg-green-400 hover:text-white transition ease-in-out delay-150  hover:-translate-y-1 hover:scale-11 duration-300">
                    View Courses
                </button>
            </div>
            <div>
