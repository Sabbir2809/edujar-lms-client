      ...
      <div className="w-full md:h-[900px] h-[820px] bg-gradient-to-r from-violet-800 via-violet-500 to-violet-800 md:flex overflow-hidden ">
        <section className="md:ml-36 ml-6 md:mr-40 mr-2">
          <div className=" text-gray-100 text-3xl font-bold tracking-widest" style={{ fontFamily: "Saira" }}>
            <h1 className="md:pt-32  pt-9">Successful coaches are visionaries</h1>
          </div>

          <div>
            <h1
              className="pt-10 md:text-12xl text-10xl font-semibold text-white tracking-normal"
          ...
          <div className="md:pt-10 pt-9">
            ...
            <button
              className="ml-8 md:text-[17px] text-[13px] text-white font-semibold"
              style={{ fontFamily: "Saira" }}
              type="submit">
              {" "}
          ...
          <div className="search md:pt-10 pt-14 md:absolute flex items-center">
            <input
              ...
              className=" input input-bordered md:w-[500px] md:h-[75px] w-96 h-12  bg-white text-black md:text-[17px] text-[13px] font-semibold md:font-bold p-7"
              style={{ fontFamily: "Saira" }}
            />

            <button
              className="btn5 btn ml-8 text-[15px] text-white border-2 rounded-[8px] border-white tracking-normal md:flex hidden"
              style={{ fontFamily: "Inter" }}
              type="submit">
              <img src={Vector} alt="Search Icon" className="mr-2" /> Search
            </button>

            <button
              className="btn btn-secondary ml-5 text-[15px] text-white border-2 rounded-[8px] tracking-normal md:hidden"
              style={{ fontFamily: "Inter" }}
              type="submit">
              <img src={Vector} alt="Search Icon" className="mr-2" />
              Search
            </button>
          </div>
        </section>
