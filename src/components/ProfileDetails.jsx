            ...
            <div className='mx-auto max-w-screen-2xl gap-10 px-12 py-10 grid md:grid-cols-2 grid-cols-1  '>
                ...
                <section className='border rounded p-4 shadow-lg h-[100%] w-full mt-10'>
                    ...
                    <div>
                        ...
                        <img className='w-32 h-32 rounded-full mx-auto ring ring-primary ring-offset-base-100 ring-offset-3 ' src="https://cdn.ostad.app/user/avatar/2023-02-19T19-47-34.458Z-FBIMG1676836030404150x150.jpg" alt="" />
                        ...
                        <div className='mt-11 h-full'>
                            ...
                            <div className='flex justify-end'>
                                <button  className='p-3 rounded bg-blueGray-700 text-white mt-5 text-center flex justify-center items-center gap-2 hover:bg-blueGray-900 font-semibold'>Save Changes <IoMdCheckmark /> </button>
                            </div>
