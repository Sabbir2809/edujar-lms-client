        ...
        <div>
            ...
            <div className="w-full h-[1600px] bg-gradient-to-r from-sky-100 to-slate-100 ">
                ...
                <div>
                    ...
                    <h1 className='text-8xl font-bold text-center pt-20 pb-10 text-black tracking-wide' style={{fontFamily: 'Rowdies'}}>
                        Featured <span className='text-[#2AAA94]'>Course</span>
                    </h1>

                    <p className='text-2xl text-center text-black tracking-wide pb-10 font-semibold' style={{fontFamily: 'Saira'}}>
                        Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed <br/>do eiusmod temporidunt ut labore veniam...
                    </p>

                </div>

                <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 md:pl-10 pl-6 lg:pl-32 pr-4 md:pr-0 md:gap-y-4 lg:gap-x-0 gap-y-4'>
